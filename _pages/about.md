...
<ul>
  <li>
    <span style="font-size: 0.98rem;"><span style="color: #000000;">Reviewer</span>: UIST '25, C&C '25<sup style="font-weight: bold;">&dagger;</sup>, CHI '25 LBW. <span style="font-size: 0.9rem; display: inline-block;">(<span style="font-weight: bold;">&dagger;</span> <i>Special Recognitions for Outstanding Reviews</i>)</span></span>
  </li>
</ul>

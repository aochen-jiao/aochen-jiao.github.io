...
<body>
  <div class="container">
    ...
    <div class="content">
      <p class="info">
        <span style="color: #000000;">Medusa3D: The Watchful Eye Freezing Illegitimate Users in Virtual Reality Interactions</span>
        <img src="../images/icon_honorable_mention.jpg" alt="award icon" style="width:20px; vertical-align:middle; margin-left:5px;">
        <span style="color: #FF0000; font-weight: bold;">Honorable Mention Award</span><br>
